...
access to the axis.
*/
	public void setYAxis(HIYAxis yAxis) {
		this.yAxis = yAxis;
		this.yAxis.addObserver(updateObserver);
		this.setChanged();
		this.notifyObservers();
	}

	public HIYAxis getYAxis(){ return yAxis; }
...
access to the axis.
 <br><br><b><i>Try it:</b></i><br><br>&ensp;&bull;&ensp; <a href="https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/3d/scatter-zaxis-categories/">Z-Axis with Categories</a><br>&ensp;&bull;&ensp; <a href="https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/3d/scatter-zaxis-grid/">Z-Axis with styling</a>*/
	public void setZAxis(HIZAxis zAxis) {
		this.zAxis = zAxis;
		this.zAxis.addObserver(updateObserver);
		this.setChanged();
		this.notifyObservers();
	}

	public HIZAxis getZAxis(){ return zAxis; }
...
*/
	public void setXAxis(HIXAxis xAxis) {
		this.xAxis = xAxis;
		this.xAxis.addObserver(updateObserver);
		this.setChanged();
		this.notifyObservers();
	}

	public HIXAxis getXAxis(){ return xAxis; }
...
public Map<String, Object> getParams() {
	...
	Map<String, Object> params = new HashMap<>();
		...
		if (this.yAxis != null) {
			params.put("yAxis", this.yAxis.getParams());
		}
		if (this.series != null) {
		...
		if (this.xAxis != null) {
			params.put("xAxis", this.xAxis.getParams());
		}
