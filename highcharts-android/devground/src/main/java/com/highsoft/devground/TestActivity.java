...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pie1.setSize("60%");
        HIDataLabels dataLabelsPie1 = new HIDataLabels();
        dataLabelsPie1.setFormatter(new HIFunction(
                f -> {
        ...
        dataLabelsPie1.setColor(HIColor.initWithHexValue("ffffff"));
        dataLabelsPie1.setDistance(-30);
        ArrayList<HIDataLabels> dataLabelsListPie1 = new ArrayList<>();
        dataLabelsListPie1.add(dataLabelsPie1);
        pie1.setDataLabels(dataLabelsListPie1);
        ...
        HIDataLabels dataLabelsPie2 = new HIDataLabels();
        dataLabelsPie2.setFormatter(new HIFunction(
                f -> {
        ...
        ArrayList<HIDataLabels> dataLabelsListPie2 = new ArrayList<>();
        dataLabelsListPie2.add(dataLabelsPie2);
        pie2.setDataLabels(dataLabelsListPie2);
