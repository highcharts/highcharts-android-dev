...
*/
public class HIYAxis implements HIChartsJSONSerializable { 
...
*/
	public ArrayList<Double> tickPositions;
...
*/
	public HIStackLabels stackLabels;
...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/xaxis/tickpositions-tickpositioner/ : Demo of tickPositions and tickPositioner
*/
	public HIGFunction /* Function */ tickPositioner;
	...
	public Map<String, Object> getParams() {
		...
		if (this.maxZoom != null) {
			params.put("maxZoom", this.maxZoom);
		}
