...
public class HIVariablepie extends HISeries {
 ...
 <br><br><b>defaults:</b><br><br>&ensp;10%	*/
	...
	/**
 Whether the pie slice's value should be represented by the area or the radius of the slice. Can be either `area` or `radius`. The defaults, `area`, corresponds best to the human perception of the size of each pie slice. 
