...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plotLines1.setColor(HIColor.initWithName("black"));
        ...
        plotLines1.getLabel().setStyle(new HICSSObject());
        ...
        plotLines2.setColor(HIColor.initWithName("black"));
        ...
        plotLines2.getLabel().setStyle(new HICSSObject());
