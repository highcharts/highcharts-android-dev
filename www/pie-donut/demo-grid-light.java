...
public class MainActivity extends AppCompatActivity {
	...
	chartView.theme = "grid-light";
        ...
        pie1.dataLabels.formatter = new HIGFunction("function () { return this.y > 5 ? this.point.name : null; }",true);
        ...
        pie2.dataLabels.formatter = new HIGFunction("function () { /* display only if larger than 1 */ return this.y > 1 ? '<b>' + this.point.name + ':</b> ' + this.y + '%' : null; }", true);
