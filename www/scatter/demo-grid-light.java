...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		plotOptions.scatter = new HIScatter();
		plotOptions.scatter.marker = new HIMarker();
		plotOptions.scatter.marker.radius = 5;
		plotOptions.scatter.marker.states = new HIStates();
		plotOptions.scatter.marker.states.hover = new HIHover();
		plotOptions.scatter.marker.states.hover.enabled = true;
		plotOptions.scatter.marker.states.hover.lineColor = HIColor.initWithRGB(100, 100, 100);
		HIStates state = new HIStates();
		state.hover = new HIHover();
		state.hover.marker = new HIMarker();
		state.hover.marker.enabled = false;
		plotOptions.scatter.states = new HIStates();
		plotOptions.scatter.states = state;
		plotOptions.scatter.tooltip = new HITooltip();
		...
		series1.name = "Female";
		series1.color = HIColor.initWithRGBA(223, 83, 83, 0.5);
		...
		series2.name = "Male";
		series2.color = HIColor.initWithRGBA(119, 152, 191, 0.5);
		Number[][] series2_data = new Number[][] {
