...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setText("Height Versus Weight of 507 Individuals by Gender");
		options.setTitle(title);

		HISubtitle subtitle = new HISubtitle();
		subtitle.setText("Source: Heinz  2003");
		...
		plotOptions.getScatter().getTooltip().setHeaderFormat("<b>{series.name}</b><br>");
		plotOptions.getScatter().getTooltip().setPointFormat("{point.x} cm, {point.y} kg");
		options.setPlotOptions(plotOptions);

		HIScatter series1 = new HIScatter();
		series1.setName("Female");
		series1.setColor(HIColor.initWithRGBA(223, 83, 83, 0.5));
		...
		series2.setColor(HIColor.initWithRGBA(119, 152, 191, 0.5));
