...
public class MainActivity extends AppCompatActivity {
		...
		chartView.theme = "grid-light";
                ...
                HISunburst series1 = new HISunburst();
                series1.type = "sunburst";
                ...
                datalabels.formatter = new HIGFunction( "function () { var shape = this.point.node.shapeArgs; var innerArcFraction = (shape.end - shape.start) / (2 * Math.PI); var perimeter = 2 * Math.PI * shape.innerR; var innerArcPixels = innerArcFraction * perimeter; if (innerArcPixels > 16) { return this.point.name; } }", true);
                series1.dataLabels = datalabels;
